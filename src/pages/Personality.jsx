  ...
  return (
    <div className='mt-[100px]'>
     ...
     <iframe className='absolute w-full top-0 h-full'
       src="https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2024/10/17/07/20241017073300-NKUUO4DH.json"  // Replace with the actual URL
